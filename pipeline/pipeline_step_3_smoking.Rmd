---
title: "Pipeline step 3 - Smoking covariates"
---

Process the smoking covariates
Run this script twice, once for the imaging visit and again for the baseline visit. Change the touchscreen variable to do this.
...
smoking_table <- read.csv(paste0(input_path, "smoking_", touchscreen, "_6_13_23.csv"))
